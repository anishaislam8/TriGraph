...
is_2_3_node_subgraphs.extend(["3 Node Subgraphs"]*len(model_3_mrr))
is_2_3_node_subgraphs.extend(["2 and 3 Node Subgraphs"]*len(model_3_mrr_main))
...
plt.title('Edge Prediction MRR for Models 1, 2, 3, 4, and 5')
plt.show()